...
const app = express();
const APP_PORT = process.env.APP_PORT || global.env.APP_PORT || 3000
...
const s3Connection = new Promise( //test s3 connection
    (resolve, reject) => {
        if ((!!process.env.AWS_S3_ACCESSKEY_ID || !!global.env.AWS_S3_ACCESSKEY_ID) && (!!process.env.AWS_S3_SECRET_ACCESSKEY || !!global.env.AWS_S3_SECRET_ACCESSKEY)) {
